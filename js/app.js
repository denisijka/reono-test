(() => {
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                item.noUiSlider.on("update", (function(values, handle) {
                    ...
                    const textSmallPrice = document.getElementById("text-small-price");
                    const textBigPrice = document.getElementById("text-big-price");
                    if (textSmallPrice && textBigPrice) {
                        textSmallPrice.innerText = inputs[0].value;
                        textBigPrice.innerText = inputs[1].value;
                    }
                }));
        ...
        if (document.querySelector("#range")) rangeInit();
